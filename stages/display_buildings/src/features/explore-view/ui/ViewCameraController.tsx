...
import { MOVEMENT_SPEEDS, CAMERA_HEIGHTS } from "@shared/config/constants";
...
import { useBuildingsSlice } from "@entities/buildings";
import { useMinimapMarkers } from "@entities/minimap";
