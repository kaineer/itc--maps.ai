...
// Constants
import { CAMERA_HEIGHTS /* , MODEL_CONSTANTS*/ } from "@shared/config/constants";

import type { Building, BuildingNode, ModelPosition } from "@entities/buildings";
import { CameraState } from "@features/align-model";
