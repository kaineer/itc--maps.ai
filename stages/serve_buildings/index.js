...
fastify.put('/buildings', {
    ...
    fastify.log.info(`Received request: position=${JSON.stringify(position)}, distance=${distance}`);
    ...
    fastify.log.info(`Found ${filteredBuildings.length} buildings within distance ${distance}`);
